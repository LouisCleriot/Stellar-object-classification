...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Data not present, please make sure you have preprocessed data, if not enter in command line:")
        print("make data")
    ...
    try: 
        ...
        print("Models not present, please make sure you have trained models or download them, if not enter in command line:")
    ...
    ax.figure.savefig('reports/figures/comparison_metrics.png', bbox_inches='tight')
    ...
    for p in ax.patches:
        if p.get_height() == 0:
            ...
            ax.annotate(f'{p.get_height():.2f}', 
                        ...
                        ha='center', va='center', 
                        xytext=(0, 10), textcoords='offset points')
    ax.figure.savefig('reports/figures/comparison_inference_time.png', bbox_inches='tight')
    ...
    fig1.savefig('reports/figures/precision_recall_curve_galaxy.png', bbox_inches='tight')
    fig2.savefig('reports/figures/precision_recall_curve_qso.png', bbox_inches='tight')
    fig3.savefig('reports/figures/precision_recall_curve_star.png', bbox_inches='tight')
